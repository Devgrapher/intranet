...
class UserConstant
{
    ...
    const TEAM_STORY_DEVELOP = '리디북스 / 개발센터 / 스토리개발팀';
    const TEAM_STORE = '리디북스 / 개발센터 / 스토어팀';
    const TEAM_DATA = '리디북스 / 개발센터 / 데이터팀';
    const TEAM_PAPER = '리디북스 / 개발센터 / 페이퍼팀';

    const TEAM_DESIGN_CONTENTS1 = '리디북스 / 디자인센터 / 콘텐츠디자인1팀';
    const TEAM_DESIGN_CONTENTS2 = '리디북스 / 디자인센터 / 콘텐츠디자인2팀';
    const TEAM_DESIGN_BRAND = '리디북스 / 디자인센터 / 브랜드디자인팀';

    const TEAM_NORMAL = '리디북스 / 사업그룹 / 일반사업부';
    const TEAM_GENRE_BL = '리디북스 / 사업그룹 / 로맨스/BL사업부';
    const TEAM_GENRE_FANTASY = '리디북스 / 사업그룹 / 판타지사업부';
    const TEAM_CM = '리디북스 / 사업그룹 / 만화사업부';
    const TEAM_DEVICE = '리디북스 / 사업그룹 / 디바이스사업부';

    const TEAM_STORE_OP = '리디북스 / 사업지원그룹 / 운영지원팀';
    const TEAM_CCPQ = '리디북스 / 사업지원그룹 / CC/PQ팀';
    const TEAM_AS = '리디북스 / 사업지원그룹 / AS/물류팀';
    const TEAM_CONTENTS_DB = '리디북스 / 사업지원그룹 / 콘텐츠DB팀';
    const TEAM_PCC = '리디북스 / 사업지원그룹 / PCC팀';
    const TEAM_STORY_OPERATION = '리디북스 / 사업지원그룹 / 스토리지원팀';
