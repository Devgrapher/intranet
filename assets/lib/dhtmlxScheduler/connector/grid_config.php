...
class GridConfiguration
{
    ...
    */
    ...
    protected $headerAttaches = [];
    protected $footerAttaches = [];
    ...
    */
    public function setColAlign($alStr)
    {
        $this->headerAlign = $this->parse_param_array($alStr,
            ["right" => 1, "left" => 1, "center" => 1, "justify" => 1],
            "left");
    }
    ...
    */
    public function setColVAlign($alStr)
    {
        $this->headerVAlign = $this->parse_param_array($alStr,
            ["baseline" => 1, "sub" => 1, "super" => 1, "top" => 1, "text-top" => 1, "middle" => 1, "bottom" => 1, "text-bottom" => 1],
            "top");
    }
