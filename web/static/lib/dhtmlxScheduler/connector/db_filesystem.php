...
class FileSystemTypes
{
    ...
    private $extentions = [];
    private $extentions_not = [];
    private $all = true;
    private $patterns = [];
    // predefined types
    private $types = [
        'image' => ['jpg', 'jpeg', 'gif', 'png', 'tiff', 'bmp', 'psd', 'dir'],
        'document' => ['txt', 'doc', 'docx', 'xls', 'xlsx', 'rtf', 'dir'],
        'web' => ['php', 'html', 'htm', 'js', 'css', 'dir'],
        'audio' => ['mp3', 'wav', 'ogg', 'dir'],
        'video' => ['avi', 'mpg', 'mpeg', 'mp4', 'dir'],
        'only_dir' => ['dir']
        ];
