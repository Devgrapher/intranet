...
class CrossOptionsConnector extends Connector
{
    ...
    public function __construct($res, $type = false, $item_type = false, $data_type = false)
    {
        ...
        EventMaster::attach_static("connectorInit", [$this, "handle"]);
    }
    ...
    public function handle($conn)
    {
        ...
        $this->link->event->attach("beforeFilter", [$this, "get_only_related"]);
        ...
        if (!$this->dload) {
            $conn->event->attach("beforeRender", [$this, "getOptions"]);
            $conn->event->attach("beforeRenderSet", [$this, "prepareConfig"]);
        }

        $conn->event->attach("afterProcessing", [$this, "afterProcessing"]);
    }
